...
const LoginForm = ({ onSubmit, isLoading = false }) => {
  ...
  return (
    <div style={{ width: '100%', maxWidth: '28rem', margin: '0 auto', padding: '0 1rem' }}>
      {/* Logo y Título */}
      ...
      {/* Tarjeta de Login */}
      <div className="fuel-card" style={{ padding: '2.5rem' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
          {/* Campo Email */}
          <div>
            <label htmlFor="email" style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: 'white', marginBottom: '0.5rem' }}>
              Correo Electrónico
            </label>
          ...
          {/* Campo Contraseña */}
          <div>
            <label htmlFor="password" style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: 'white', marginBottom: '0.5rem' }}>
              Contraseña
            </label>
            <div style={{ position: 'relative' }}>
              <div style={{ position: 'absolute', top: '50%', left: '0.75rem', transform: 'translateY(-50%)', pointerEvents: 'none' }}>
