...
const DriverDashboard: React.FC<Props> = ({
    ...
    <div className="space-y-6">
        ...
        <div className="grid xl:grid-cols-4 md:grid-cols-2 gap-6">
            ...
            <div className="fuel-card p-6 xl:col-span-3">
                <div className="flex items-center gap-2 mb-4">
                ...
                {today.length === 0 ? (
                    ...
                    <div className="space-y-3">
                        {today.map(t => (
                            <div key={t.id} className="fuel-card p-4 flex items-center justify-between hover:shadow-lg transition-all duration-300">
                                <div className="flex items-center gap-4">
                                    <div className="p-2 rounded-lg bg-slate-800/50">
                                        <Route className="w-5 h-5 text-blue-400" />
                                    </div>
                                    <div>
                                        <div className="font-semibold text-white text-lg">{t.origen} → {t.destino}</div>
