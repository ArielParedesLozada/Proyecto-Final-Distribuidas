                                    ...
                                    {route.observations.map((obs) => {
                                      ...
                                      if (obsDate) {
                                        if (typeof obsDate === 'object' && obsDate !== null && 'seconds' in obsDate) {
                                          ...
                                          dateStr = new Date(ts.seconds * 1000 + (ts.nanos || 0) / 1000000).toLocaleString('es-ES');
                ...
                <div>
                  ...
                  {isLoadingUnassignedRoutes ? (
                    ...
                    <select
                      ...
                      className={`w-full px-4 py-3 bg-slate-700/50 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-colors ${assignErrors.route ? 'border-red-500' : 'border-slate-600'
                        }`}
                      required
                    >
                ...
                <div>
                  ...
                  {isLoadingDrivers ? (
                    ...
                    <select
                      ...
                      className={`w-full px-4 py-3 bg-slate-700/50 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-colors ${assignErrors.driver ? 'border-red-500' : 'border-slate-600'
                        }`}
                      required
                    >
                ...
                <div>
                  ...
                  {!selectedDriverId ? (
                    ...
                    <select
                      ...
                      className={`w-full px-4 py-3 bg-slate-700/50 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-amber-500/50 transition-colors ${assignErrors.assignment ? 'border-red-500' : 'border-slate-600'
                        }`}
                      required
            ...
            <div className="bg-amber-600/10 border border-amber-600/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-slate-300">
                  <p className="font-medium text-amber-400 mb-1">Información sobre la asignación:</p>
